...
int main() {
  ...
  bf1.insert("hello");
  bf1.insert("world");
  std::cout << "bf1.contains(\"hello\"): " << bf1.contains("hello")
            << std::endl;
  std::cout << "bf1.contains(\"world\"): " << bf1.contains("world")
            << std::endl;
  ...
  bf1.writeBFtoFile(filename);

  // lseek(fd, 0, SEEK_SET);

  Bloomfilter bf2(filename);
  // close(fd);

  std::cout << "bf2.contains(\"hello\"): " << bf2.contains("hello")
            << std::endl;
  std::cout << "bf2.contains(\"world\"): " << bf2.contains("world")
            << std::endl;
